    ...
    <div class="header-content">
        ...
        <div class="header-right">
            ...
            if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
                ...
                echo '<a href="#" class="btn header-button signin-button" id="openModalBtn"><span class="desktop-text">Sign In/Sign Up</span><i class="fas fa-user-circle mobile-icon"></i></a>';
            }
            ?>
        </div>
